...
class Grad(_Merge):
    """
    Layer that takes the gradient with respect to a specific ouput. 
    The output tensor should be the second tensor.
    The input tensor should be the first tensor.
    """
