...
class Convolution1D(Layer):
    ...
    # Arguments
        ...
        W_learning_rate_multiplier: Multiplier (between 0.0 and 1.0) applied to the learning 
            rate of the main weights matrix. 
        b_learning_rate_multiplier: Multiplier (between 0.0 and 1.0) applied to the learning 
            rate of the bias. 
...
class Convolution2D(Layer):
    ...
    def get_config(self):
        config = {'nb_filter': self.nb_filter,
                  ...
                  'bias': self.bias,
                  'W_learning_rate_multiplier': self.W_learning_rate_multiplier if self.W_learning_rate_multiplier else None,
                  'b_learning_rate_multilpier': self.b_learning_rate_multiplier if self.b_learning_rate_multiplier else None
        }
...
class Deconvolution2D(Convolution2D):
    ...
    def __init__(self, nb_filter, nb_row, nb_col, output_shape,
        ...
        super(Deconvolution2D, self).__init__(nb_filter, nb_row, nb_col,
                                              ...
                                              W_constraint=W_constraint, b_constraint=b_constraint,
                                              bias=bias,
                                              W_learning_multiplier=W_learning_multiplier,
                                              b_learning_multiplier=b_learning_multiplier,
                                              **kwargs)
...
class SeparableConvolution2D(Layer):
    ...
    # Arguments
        ...
        bias: whether to include a bias
            (i.e. make the layer affine rather than linear).
        depthwise_learning_rate_multiplier: Multiplier (between 0.0 and 1.0) applied to the learning             rate of the depthwise weights matrix. 
        pointwise_learning_rate_multiplier: Multiplier (between 0.0 and 1.0) applied to the learning              rate of the pointwise weights matrix. 
        b_learning_rate_multiplier: Multiplier (between 0.0 and 1.0) applied to the learning rate of              the bias 
    ...
    def __init__(self, nb_filter, nb_row, nb_col,
                 ...
                 b_constraint=None,
                 bias=True,
                 depthwise_learning_rate_multiplier=None,
                 pointwise_learning_rate_multiplier=None,
